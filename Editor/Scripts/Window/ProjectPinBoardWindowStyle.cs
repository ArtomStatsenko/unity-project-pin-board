    ...
    public partial class ProjectPinBoardWindow
    {
        ...
        private static class Theme
        {
            public static Color GetColor(string name)
            {
                if (isDarkTheme)
                {
                    if (s_DarkColor.TryGetValue(name, out Color color))
                        return color;
                }
                else
                {
                    if (s_LightColor.TryGetValue(name, out Color color))
                        return color;
                }
            ...
            private static readonly Dictionary<string, Color> s_DarkColor = new Dictionary<
                string,
                Color
            >()
            {
            ...
            private static readonly Dictionary<string, Color> s_LightColor = new Dictionary<
                string,
                Color
            >()
            {
